...
public class Events {
    ...
    public static int MIN = Config.MIN_VALUE_TIME.getAsInt() <= Config.MAX_VALUE_TIME.getAsInt()
            ? Config.MIN_VALUE_TIME.getAsInt()
            : Config.MAX_VALUE_TIME.getAsInt();
    public static int MAX = Config.MIN_VALUE_TIME.getAsInt() >= Config.MAX_VALUE_TIME.getAsInt()
            ? Config.MIN_VALUE_TIME.getAsInt()
            : Config.MAX_VALUE_TIME.getAsInt();
